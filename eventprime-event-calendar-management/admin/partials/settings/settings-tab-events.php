...
<table class="form-table">
    <tbody>
        ...
        <tr valign="top" class="ep_enable_card_view_custom_value_child" style="<?php echo ( ( $global_options->default_cal_view == 'card' || $global_options->default_cal_view == 'square_grid' || $global_options->default_cal_view == 'masonry' || $global_options->default_cal_view == 'staggered_grid' || $global_options->default_cal_view == 'list' || $global_options->default_cal_view == 'rows' || $global_options->default_cal_view == 'slider' || $global_options->default_cal_view == 'month' || $global_options->default_cal_view == 'week' || $global_options->default_cal_view == 'day' || $global_options->default_cal_view == 'listweek' ) &&  $global_options->show_no_of_events_card == 'custom' ) ? '' : 'display:none;';?>">
            <th scope="row" class="titledesc">

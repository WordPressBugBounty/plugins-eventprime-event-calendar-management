...
<div class="ep-setting-tab-content">
    <?php 
        $event_types_text = $ep_functions->ep_global_settings_button_title('Event-Types');
        $event_type_text = $ep_functions->ep_global_settings_button_title('Event-Type');
    ?>
...
<table class="form-table">
    <tbody>
            ...
            <td class="forminp forminp-text">
                <select name="type_display_view" id="ep_settings_front_display_view" class="ep-form-control">
                    ...
                    foreach( $sub_options['front_view_list_styles'] as $key => $view_name ){ ?>
                        <option value="<?php echo esc_attr( $key );?>" <?php if( $global_options->type_display_view == $key ) { echo 'selected="selected"'; } ?>>
        ...
        <tr valign="top" id="ep_settings_card_background" <?php if( $global_options->type_display_view != 'box' && $global_options->type_display_view != 'colored_grid' ) { echo 'style="display:none;"'; } ?>>
            <th scope="row" class="titledesc">
            ...
            <td class="forminp forminp-text">
                <?php foreach( $global_options->type_box_color as $key => $color ){?>
                    <input type="text" data-jscolor="{}" name="type_box_color[<?php echo $key;?>]" id="performer_box_color_<?php echo $key;?>" value="<?php echo esc_attr( $global_options->type_box_color[$key] );?>"><?php
                }?>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <input type="number" min="0" name="type_limit" class="regular-text" id="type_limit" value="<?php echo esc_attr( $global_options->type_limit );?>">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="type_no_of_columns" id="type_no_of_columns" class="ep-form-control">
                    <option value="1" <?php if( $global_options->type_no_of_columns == 1 ){ echo 'selected'; } ?> >1</option>
                    <option value="2" <?php if( $global_options->type_no_of_columns == 2 ){ echo 'selected'; } ?> >2</option>
                    <option value="3" <?php if( $global_options->type_no_of_columns == 3 ){ echo 'selected'; } ?> >3</option>
                    <option value="4" <?php if( $global_options->type_no_of_columns == 4 ){ echo 'selected'; } ?>>4</option>
                </select>  
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="type_load_more"  id="type_load_more" <?php if( $global_options->type_load_more == 1 ){ echo 'checked="checked"'; }?>>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="type_search" " id="type_search" <?php if( $global_options->type_search == 1 ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
...
<table class="form-table">
    <tbody>
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_type_show_events" onclick="ep_frontend_view_child_hide_show(this,'ep_frontend_view_child')" id="single_type_show_events" <?php if( esc_attr( $global_options->single_type_show_events == 1 ) ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
...
<table id="ep_frontend_view_child" class="form-table" style="<?php if( esc_attr( $global_options->single_type_show_events == 1 ) ){ echo 'display:block;"'; }else{ echo 'display:none;';}?>">
    <tbody>
        <tr valign="top">
            <th scope="row" class="titledesc">
            ...
            <td class="forminp forminp-text">
                <select name="single_type_event_display_view" class="ep-form-control">
                    ...
                    foreach( $sub_options['front_view_event_styles'] as $key => $view_name ){ ?>
                        <option value="<?php echo esc_attr( $key );?>" <?php if( $global_options->single_type_event_display_view == $key ) { echo 'selected="selected"'; } ?>>
                            <?php echo esc_html( $view_name );?>
                        </option><?php
                    }?>
                </select>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <input type="number" min="0" name="single_type_event_limit" class="regular-text" id="single_type_event_limit" value="<?php echo esc_attr( $global_options->single_type_event_limit );?>">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="single_type_event_column" id="single_type_event_column" class="ep-form-control">
                    <option value="1" <?php if( $global_options->single_type_event_column == 1 ){ echo 'selected'; } ?> >1</option>
                    <option value="2" <?php if( $global_options->single_type_event_column == 2 ){ echo 'selected'; } ?> >2</option>
                    <option value="3" <?php if( $global_options->single_type_event_column == 3 ){ echo 'selected'; } ?> >3</option>
                    <option value="4" <?php if( $global_options->single_type_event_column == 4 ){ echo 'selected'; } ?>>4</option>
                </select> 
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="single_type_event_order" id="single_type_event_order" class="ep-form-control">
                    <option value="asc" <?php if( $global_options->single_type_event_order == 'asc' ){ echo 'selected'; } ?> ><?php esc_html_e('Ascending','eventprime-event-calendar-management');?></option>
                    <option value="desc" <?php if( $global_options->single_type_event_order == 'desc' ){ echo 'selected'; } ?> ><?php esc_html_e('Descending','eventprime-event-calendar-management');?></option>
                </select> 
                <div class="ep-help-tip-info ep-my-2 ep-text-muted"><?php esc_html_e( 'Number of columns in Square Grid view.', 'eventprime-event-calendar-management' );?></div>
            </td>
        </tr>
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <select name="single_type_event_orderby" id="single_type_event_orderby" class="ep-form-control">
                    <option value="em_start_date_time" <?php if( $global_options->single_type_event_orderby == 'em_start_date_time' ){ echo 'selected'; } ?> ><?php esc_html_e('Event Start Date','eventprime-event-calendar-management');?></option>
                    <option value="em_end_date_time" <?php if( $global_options->single_type_event_orderby == 'em_end_date_time' ){ echo 'selected'; } ?> ><?php esc_html_e('Event End Date','eventprime-event-calendar-management');?></option>
                    <option value="ID" <?php if( $global_options->single_type_event_orderby == 'ID' ){ echo 'selected'; } ?> ><?php esc_html_e('Event ID','eventprime-event-calendar-management');?></option>
                    <option value="title" <?php if( $global_options->single_type_event_orderby == 'title' ){ echo 'selected'; } ?>><?php esc_html_e('Title','eventprime-event-calendar-management');?></option>
                </select> 
                <div class="ep-help-tip-info ep-my-2 ep-text-muted"><?php esc_html_e( 'Number of columns in Square Grid view.', 'eventprime-event-calendar-management' );?></div>
            </td>
        </tr>
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_type_event_load_more"  id="single_type_event_load_more" <?php if( $global_options->single_type_event_load_more == 1 ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                <label class="ep-toggle-btn">
                    <input type="checkbox" name="single_type_hide_past_events"  id="single_type_hide_past_events" <?php if( $global_options->single_type_hide_past_events == 1 ){ echo 'checked="checked"'; }?>>
                    <span class="ep-toogle-slider round"></span>
                </label>
        ...
        <tr valign="top">
            <th scope="row" class="titledesc">
                <label for="single_type_event_section_title">
                    <?php esc_html_e( 'Events Section Title', 'eventprime-event-calendar-management' );?>
                </label>
            </th>
            <td class="forminp forminp-text">
                    <input name="single_type_event_section_title" id="single_type_event_section_title" type="text" value="<?php echo isset( $global_options->single_type_event_section_title ) && ! empty( $global_options->single_type_event_section_title ) ? esc_attr( $global_options->single_type_event_section_title ) : esc_attr__("Upcoming Events", "eventprime-event-calendar-management"); ?>">
                <div class="ep-help-tip-info ep-my-2 ep-text-muted"><?php esc_html_e( 'The title for the event section displayed on the single event-type page.', 'eventprime-event-calendar-management' );?></div>
            </td>
        </tr>
        <tr valign="top">
            <th colspan="2">

    ...
    if( ! empty( $args->login_required ) ) {?>
        ...
        if( ! empty( $hasUserRestriction ) ) {?>
            ...
            <form class="ep-frontend-event-form" id="ep_frontend_event_form" method="post">
                ...
                $ep_functions->ep_get_template_part( 'events/frontend-submission/date_time', null, $args );

                // Load tickets template
                $ep_functions->ep_get_template_part( 'events/frontend-submission/tickets', null, $args );
                
                // Load event types template
                $ep_functions->ep_get_template_part( 'events/frontend-submission/event_types', null, $args );

                // Load venues template
                $ep_functions->ep_get_template_part( 'events/frontend-submission/venues', null, $args );

                // Load performers template
                $ep_functions->ep_get_template_part( 'events/frontend-submission/performers', null, $args );

                // Load performers template
                $ep_functions->ep_get_template_part( 'events/frontend-submission/organizers', null, $args );

    ...
    <div class="ep-fes-section ep-mb-4 ep-border ep-p-4 ep-shadow-sm ep-rounded-1 ep-bg-white">
        ...
        <?php if(isset($args->fes_new_event_location) && !empty($args->fes_new_event_location)):?>
            ...
            if(!empty($gmap_api_key)){
                wp_enqueue_script('google_map_key', 'https://maps.googleapis.com/maps/api/js?key='.$gmap_api_key.'&libraries=places,marker,drawing,geometry&loading=async', array(), EVENTPRIME_VERSION);
            }?>

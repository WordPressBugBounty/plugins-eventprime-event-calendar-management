    ...
    <div class="emagic ep-position-relative" id="ep_event_edit_booking_page">
        ...
        <div class="ep-box-wrap">
            ...
            <div class="ep-box-row ep-mt-5 ep-mb-3">
                <?php $image_url = ($args->booking_data->event_data->image_url)?$args->booking_data->event_data->image_url:$args->booking_data->event_data->placeholder_image_url; ?>
                <div class="ep-box-col-2 ep-pr-2 ep-border-right ep-border-warning ep-border-3 ep-lh-0 ep-box-col-sm-2 ep-box-col-xsm-2">
                    <img class="ep-checkout-img-icon ep-rounded-1" src="<?php echo esc_url( $image_url );?>" alt="<?php echo esc_html( $args->booking_data->event_data->name );?>" style="max-width:100%;">
                </div>
                ...
                <div class="ep-box-col-10 ep-text-start ep-lh-1 ep-box-col-sm-10 ep-box-col-xsm-10">
                    ...
                    <div class="ep-fs-6">
                        <div class="ep-d-inline-flex ep-align-items-center">
                            <?php echo esc_html( $args->booking_data->event_data->fstart_date );?>, <?php echo esc_html( $ep_functions->ep_convert_time_with_format( $args->booking_data->event_data->em_start_time ) );?>
                ...
                <form name="checkout_form" class="needs-validation ep-box-col-12" novalidate="" id="ep_event_edit_booking_form">
                                                            ...
                                                            <div class="ep-p-2">
                                                                ...
                                                                <?php if( $event_ticket_data->category_id && $event_ticket_data->category_id > 0 ) {?>
                                                                    <div>
                                                                        ...
                                                                        <strong><?php echo esc_html( $ep_functions->get_ticket_category_name( $event_ticket_data->category_id, $args->booking_data->event_data ) );?></strong>
                                                                    </div><?php
                                                                }?>
                                                                <div>
                                                                ...
                                                                if( $at_field_num == $q ) {
                                                                    ...
                                                                    foreach( $single_ticket_sec as $key => $ticket_attendee_data ) {
                                                                        if( $key == 'name' ) {
                                                                            ...
                                                                            if( isset( $checkout_fields->type ) && in_array( $checkout_fields->type, $core_field_types ) ) {?>
                                                                                <div class="ep-mb-3">
                                                                                    <label for="name" class="form-label ep-text-small">
                    ...
                    <div class="ep-box-row">
                        ...
                        <div class="ep-box-col-1">
                            <a href="<?php echo esc_url( $ep_functions->ep_get_custom_page_url( 'profile_page' ) );?>">

...
if( isset( $args->organizers ) && !empty( $args->organizers ) ) {?>
    ...
    switch ( $args->display_style ) {
        case 'card':
        case 'grid':
            $ep_function->ep_get_template_part( 'organizers/list/views/card', null, $args );
            break;
        case 'box':
        case 'colored_grid': 
            $ep_function->ep_get_template_part( 'organizers/list/views/box', null, $args );
            break;
        case 'list':
        case 'rows': 
            $ep_function->ep_get_template_part( 'organizers/list/views/list', null, $args );
            break;
        default: 
            $ep_function->ep_get_template_part( 'organizers/list/views/card', null, $args ); // Loading card view by default
    }    
} else{?>

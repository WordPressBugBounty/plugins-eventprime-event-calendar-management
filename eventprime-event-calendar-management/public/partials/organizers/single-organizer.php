            ...
            <div class="ep-view-container">
                ...
                <div class="ep-box-wrap ep-details-info-wrap">
                    <div class="ep-box-row">
                        ...
                        $ep_functions->ep_get_template_part( 'organizers/single-organizer/image', null, $args );
                        ?>
                        <?php
                        // Load single organizer image template
                        $ep_functions->ep_get_template_part( 'organizers/single-organizer/detail', null, $args );
                        ?>
                    </div>
                </div>
                ...
                if( $args->event_args['show_events'] == 1 ) {
                    ...
                    $ep_functions->ep_get_template_part( 'organizers/single-organizer/upcoming-events', null, $args );
                }?>
            </div>
        </div><?php
    } else{?>

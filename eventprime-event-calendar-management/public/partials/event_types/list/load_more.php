...
if( $max_num_pages > 1 && isset( $args->load_more ) && $args->load_more == 1 ) {?>
    <div class="ep-types-load-more ep-frontend-loadmore ep-box-w-100 ep-my-4 ep-text-center">
        ...
        <button data-max="<?php echo esc_attr($max_num_pages);?>" id="ep-loadmore-event-types" class="ep-btn ep-btn-outline-primary"><span class="ep-spinner ep-spinner-border-sm ep-mr-1"></span><?php esc_html_e( 'Load more', 'eventprime-event-calendar-management' );?></button>
    </div><?php
}?>